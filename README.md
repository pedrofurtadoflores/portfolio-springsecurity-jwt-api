# Portfolio Spring Security JWT API – Spring Boot

This is a portfolio project built with Java and Spring Boot, showcasing a secured RESTful CRUD API using stateless authentication with JSON Web Tokens (JWT) and Spring Security. The application follows the MVC architecture (Model-View-Controller) and demonstrates clean code practices, DTO validation, Swagger documentation, and unit testing.
